...
<h1 align="center">mayanwrc</h1>

<p align="center">
  <b>Landing page for mayan wildlife rescue center</b><br />
...
<p align="center">
  <img src="https://raw.githubusercontent.com/luisfalconmx/mayanwrc/main/.github/screenshot.png" alt="Mayanwrc" width="100%" />
</p>
...
```bash
# HTTPS
https://github.com/luisfalconmx/mayanwrc.git
```

```bash
# SSH
git@github.com:luisfalconmx/mayanwrc.git
```

```bash
# GITHUB CLI
gh repo clone luisfalconmx/mayanwrc
```
...
We use GitHub Discussions to talk about all sorts of topics related to documentation and this site. For example: if you'd like to help troubleshooting a PR, have a great new idea, or want to share something amazing you've learned in our docs, join us in the [discussions](https://github.com/luisfalconmx/mayanwrc/discussions).

## Roadmap

Our project roadmap is where you can learn about what features we're working on, what stage they're in, and when we expect to bring them to you. Have any questions or comments about items on the roadmap? Share your feedback in [discussions](https://github.com/luisfalconmx/mayanwrc/discussions) section.

Review the project roadmap. Maybe there is something amazing that you can contribute 😉

[https://github.com/luisfalconmx/mayanwrc/projects?type=beta](https://github.com/luisfalconmx/mayanwrc/projects?type=beta)
...
[https://github.com/luisfalconmx/mayanwrc/releases](https://github.com/luisfalconmx/mayanwrc/releases)
...
[https://github.com/luisfalconmx/mayanwrc/deployments](https://github.com/luisfalconmx/mayanwrc/deployments)

For better understand, it is advisable to follow the instructions detailed in [contributing](https://github.com/luisfalconmx/mayanwrc#contributing) section.

## License

This project is free and open-source software licensed under the [MIT Licence](https://github.com/luisfalconmx/mayanwrc/blob/main/LICENSE).
